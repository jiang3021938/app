...
const stateRules: Record<string, StateDepositRule> = {
  ...
  CA: { name: "California", multiplier: 1, description: "1 month's rent (unfurnished)", notes: "1 month for unfurnished, 2 months for furnished units." },
  ...
  KS: { name: "Kansas", multiplier: 1, description: "1 month's rent (unfurnished)", notes: "1 month for unfurnished, 1.5 months for furnished units." },
  ...
  NC: { name: "North Carolina", multiplier: 2, description: "2 months' rent (week-to-week: 2 weeks)", notes: "1.5 months for month-to-month; 2 months for longer terms." },
  OH: { name: "Ohio", multiplier: null, description: "No statutory limit", notes: "No state law capping security deposit amounts." },
  PA: { name: "Pennsylvania", multiplier: 2, description: "2 months' rent (first year)", notes: "First year: 2 months; after that, 1 month maximum." },
